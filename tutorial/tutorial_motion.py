...
from feature_description import features_description

FILEPATH = '/mnt/dataset/wod/motion/'
FILENAME = 'uncompressed_tf_example_training_training_tfexample.tfrecord-00002-of-01000'
...
if __name__ == '__main__':
    ...
    data = next(dataset.skip(n).take(1).as_numpy_iterator())
    parsed = tf.io.parse_single_example(data, features_description)
    
    # Draw dataset
    images = visualize_all_agents_smooth(parsed)
    anim = create_animation(images[::2])
    anim.save(f'/mnt/git/ml4d/output/{FILENAME}_{n}.mp4', writer='ffmpeg')        
